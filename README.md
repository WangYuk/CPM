...
关于经管的一些计算。欢迎提建议/一起搞新功能/找bug。
 ...
 【卓纯有光诚】增加了关于挣得值以及最佳订货批量的计算，可以在[这里](https://github.com/zyy-student/CPM)下载`挣得值.jar, 最佳订货批量.jar`
...
| 2020.06.21 | 第15章增加了静态回收期的计算，【卓纯有光诚】增加了关于挣得值的计算以及最佳订货批量的计算 |
...
因此，如果您的输入中有多个活动可以同时开始，需要引入虚拟活动`start-0`，并补充它与可以同时开始活动的关系`start-Activity-FS-0`；相应地，如果有多个活动可以同时结束，需要引入虚拟活动`finish-0`，并补充它与可以同时结束活动的关系`Activity-end-FS-0`.同时，**开始活动、终止活动、活动个数、活动间关系个数**也应当有相应的修改。
